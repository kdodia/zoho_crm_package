...
class Zoho_crm:
    ...
    def yield_page_from_module(self,
                               module_name: str,
                               criteria: str = None,
    ...
    def delete_from_module(self, module_name: str,
        ...
        r = self.requests_session.delete(url=url,
                                         headers=headers,
    ...
    def upsert_zoho_module(
        ...
        if r.ok:
            ...
            return True, self.get_record_by_id(module_name=module_name,
                                               record_id=record_id)
        else:
            return False, r.json()
    ...
    def _refresh_access_token(self) -> dict:
        ...
        if r.status_code == 200:
            ...
            raise RuntimeError(
                f"API failure trying to get access token: {r.reason}")
